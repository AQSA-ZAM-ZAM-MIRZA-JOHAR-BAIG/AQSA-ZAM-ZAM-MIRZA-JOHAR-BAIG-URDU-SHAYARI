...
import { Scale, MapPin, Mail, Linkedin, Github } from 'lucide-react'
...
const footerLinks = [
  ...
  { title: 'Legal Work', links: [
    { name: 'Legal Research', href: '/portfolio' },
    { name: 'Legal Drafting', href: '/portfolio' },
    { name: 'Moot Court', href: '/portfolio' },
    { name: 'Constitutional Law', href: '/blogs' },
  ]},
  { title: 'Creative', links: [
    { name: 'Urdu Shayari', href: '/urdu-shayari' },
    { name: 'Ghazals', href: '/urdu-shayari' },
    { name: 'Technical Writing', href: '/blogs' },
    { name: 'Legal Blogs', href: '/blogs' },
  ]},
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <Scale className="w-6 h-6 text-amber-500" aria-hidden="true" />
            ...
            <p className="text-xs text-slate-400 mb-4 leading-relaxed">
              Law Student at PDLC Amravati · Legal Researcher · Technical Writer · Urdu Shayari Poet
            </p>
            ...
            <div className="flex items-center gap-1 text-xs text-slate-400">
              ...
              <a href="mailto:aqsajoharbaig@gmail.com" className="hover:text-amber-400 transition-colors">
